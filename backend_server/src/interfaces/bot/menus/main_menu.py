...
from src.interfaces.web_app.config import settings as web_app_settings
from src.schemas.topic_of_day import TopicOfDaySchema
from src.services.topic_of_day import TopicOfDayService
